/**
 * File: ArchController.java
 * ---------------------------
 * Provided for the arch program, not written by me. Creates the window
 * that displays everything and a JPanel that allows a number of steps
 * to run the program to be chosen.
 */
